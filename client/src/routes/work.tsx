...
const timeline: Timeline[] = [
  {
    ...
    image: '/gathering.png',
    subtitle:
      'A cultural program to celebrate Shree Vishwakarma Puja, with community prayers and Mahaprasad.',
      ...
      <div className="pt-32 pb-16 bg-parchment">
        <div className="px-4 md:px-32 grid gap-6 md:grid-cols-2 items-end text-center md:text-left mb-12">
          ...
          <p className="text-gray-700 md:text-lg max-w-[50ch] mx-auto md:mx-0 leading-relaxed">
            ...
            <span className="font-semibold">Vishwakarma Samaja</span> is
            invested with care. From purchasing community plots to supporting
            education and cultural initiatives, this timeline highlights how
            your donations have been transformed into meaningful impact.
          </p>
        </div>
        ...
        {timeline.map((expense, i) => (
          ...
          >
            ...
            <div className="pt-2">
              ...
              <h3 className="font-Poppins text-lg md:text-base mb-2 leading-snug">
                {expense.heading}
              </h3>
              <img
                src={expense.image}
